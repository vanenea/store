        ...
        <div id="box" >
            <div id="content_box">
                ...
                <div class="imfor">
                    ...
                    <div class="pudc">
                        <div class="pudc_information" id="pudcId2">
                            ...
                            <input type="hidden" name="" value="">
                         		<span class="des lf">${cart.goodsTitle }
                               <input type="hidden" name="" value="">
                        		</span>
                            <p class="col lf"><span>分类：</span><span class="color_des">${cart.goodsItemType }<input type="hidden" name="" value=""></span></p>
                        </div>
                    </div>
                    <div class="pices">
                    ...
                    <div class="num"><span class="reduc">&nbsp;-&nbsp;</span><input type="text" value="${cart.goodsCount }" /><span class="add">&nbsp;+&nbsp;</span></div>
                    <div class="totle">
                        <span>￥</span>
                        <span class="totle_information">${cart.goodsPrice * cart.goodsCount }.00</span>
                    </div>
                    <div class="del">
                        <!-- <div>
            ...
            <div class="foot">
                ...
                <div class="foot_cash" id="go-buy">
                	<input class="submit" type="submit" value="去结算" />
                </div>
