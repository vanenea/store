...
<head lang="en">
	...
	<link href="../css/icon/css/bootstrap.min.css" rel="stylesheet" type="text/css">
	<link href="../css/icon/css/cropper.min.css" rel="stylesheet">
	<link href="../css/icon/css/sitelogo.css" rel="stylesheet">
	<link href="../css/icon/css/font-awesome.min.css" rel="stylesheet" type="text/css">
