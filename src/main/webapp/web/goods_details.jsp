    ...
    <div class="right_detail lf">
        ...
        <p class="accountChose">
            ...
            <input type="text" value="1" 
            	class="number" id="buy-num"
            	name="goodsCount">
            <input type="button" value="+" 
            	class="numberAdd" />
            <input type="hidden" 
            	name="goodsId" value="${goods.id }" />
            <input type="hidden" 
            	name="goodsImage" value="${goods.image }" />
            <input type="hidden" 
            	name="goodsTitle" value="${goods.title }" />
            <input type="hidden" 
            	name="goodsItemType" value="${goods.itemType }" />
            <input type="hidden" 
            	name="goodsPrice" value="${goods.price }" />
            </form>
        </p>
        <!-- 购买部分-->
        <div class="shops">
